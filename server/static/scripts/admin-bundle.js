...
var _smoothscrollPolyfill = __webpack_require__(96);
...
var $export = __webpack_require__(4);
var $includes = __webpack_require__(32)(true);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.onAddPhoto = _this.onAddPhoto.bind(_this);
    _this.onDeleteClick = _this.onDeleteClick.bind(_this);
    _this.onSetToken = _this.onSetToken.bind(_this);
    _this.onBatchUpdatePhotos = _this.onBatchUpdatePhotos.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function onAddPhoto(photo) {
      _fetch2.default.post('/photos', photo);
    }
  }, {
    key: 'onDeleteClick',
    value: function onDeleteClick(photo) {
      _fetch2.default.delete('/photos/' + photo.key);
    }
  }, {
    key: 'onSetToken',
    ...
    value: function onBatchUpdatePhotos(photos) {
      if (photos.length) {
        _fetch2.default.postJSON('/photos/metadata', photos);
      } else {
    ...
    value: function render() {
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(_authenticator2.default, { onSetToken: this.onSetToken }),
          (0, _preact.h)(
            'div',
            ...
            (0, _preact.h)(_photoUploader2.default, { onAddPhoto: this.onAddPhoto }),
            (0, _preact.h)('hr', null),
            (0, _preact.h)(
              'h1',
              null,
...
var _batchUpdateMapper = __webpack_require__(90);
...
var BatchUpdatePhotos = function (_Component) {
  _inherits(BatchUpdatePhotos, _Component);

  function BatchUpdatePhotos() {
    _classCallCheck(this, BatchUpdatePhotos);

    var _this = _possibleConstructorReturn(this, (BatchUpdatePhotos.__proto__ || Object.getPrototypeOf(BatchUpdatePhotos)).call(this));
...
var _arrayIsEqual = __webpack_require__(91);
...
var _editPhoto = __webpack_require__(93);
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(
            'div',
            { className: 'thumb' },
            (0, _preact.h)('img', { src: photo.sizes.thumb.url })
          ),
          (0, _preact.h)(
            'div',
            { className: 'form' },
...
function fetchWithHeaders(url) {
  ...
  return window.fetch(url, _extends({ headers: headers }, additionalRequestOptions)).then(function (response) {
