...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function getStats() {
      ...
      _fetch2.default.get('/stats').then(function (stats) {
        return stats.json();
      }).then(function (stats) {
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        ...
        !!stats.length && (0, _preact.h)(_graph2.default, { data: stats })
      );
    }
  }]);
...
var _chartist = __webpack_require__(113);
...
function parseData(data) {
  return data.reduce(function (prevVal, curVal) {
    var ca = new Date(curVal.createdAt);
    var dateKey = [ca.getFullYear(), ca.getMonth() + 1, ca.getDate()].join('-');
    var newObj = prevVal[dateKey] || {
      bots: 0,
      humans: 0
    };
    var valueKey = curVal.isBot ? 'bots' : 'humans';
...
var Graph = function (_Component) {
  ...
  _createClass(Graph, [{
    ...
    value: function componentDidMount() {
      var data = parseData(this.props.data);

      var labels = Object.keys(data);
      var hits = Object.values(data);
      var series = [hits.map(function (h) {
        return h.bots;
      }), hits.map(function (h) {
        return h.humans;
      })];

      new _chartist2.default.Line('#graph', {
        labels: labels,
        series: series
      }, {
        fullWidth: true,
    ...
    key: 'render',
    value: function render() {
      return (0, _preact.h)('div', { id: 'graph' });
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=admin-stats-bundle.js.map