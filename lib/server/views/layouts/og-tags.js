...
var _photoDataConversion = require('../../../common/photo-data-conversion');
...
exports.default = function (data, _ref2) {
    var selectedPhotoKey = _ref2.selectedPhotoKey,
        year = _ref2.year,
        location = _ref2.location;

    var match = data.photoData.photos.filter(function (p) {
    ...
    if (match) {
        var selectedPhoto = (0, _photoDataConversion.serverToClient)(match, data.photoData.base);
